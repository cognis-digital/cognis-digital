# Installing cognis-digital

`cognis-digital` runs anywhere Python 3.10+ runs. Pick your OS:
...
| **Any (pip)** | `pip install cognis-cognis-digital` |
| **Docker** | `docker run --rm ghcr.io/cognis-digital/cognis-digital:latest --help` |
