...
<img src="https://img.shields.io/badge/Stars-113-6b46c1?style=for-the-badge&logo=github&logoColor=white"/>
...
**407** self-hostable, MCP-native tools · **113** stars · flagship **[c2detect](https://github.com/cognis-digital/c2detect)** (⭐32)
...
| Tool | What it does |
| --- | --- |
| **[c2detect](https://github.com/cognis-digital/c2detect)** ⭐32 | C2 server fingerprinter — Cobalt Strike, Sliver, Mythic, Havoc, Brute Ratel |
| **[packpeek](https://github.com/cognis-digital/packpeek)** ⭐3 | Static packer/loader fingerprinter (C) — UPX/ASPack/Themida/MPRESS/VMProtect + entropy; emits YARA + SARIF. JSON out, CI-tested. |
...
| Tool | What it does |
| --- | --- |
| **[awesome-drone-warfare-osint](https://github.com/cognis-digital/awesome-drone-warfare-osint)** ⭐6 | Citation-grade OSINT dataset: 8,300+ foreign components across 195+ drone & missile platforms, with cited effectiveness/EW/counter-UAS statistics. MIT (code) / CC BY 4.0 (data). |
